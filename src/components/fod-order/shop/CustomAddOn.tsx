...
export const CustomAddOn: React.FC<CustomAddOnProps> = ({ selectedItem, onClose }) => {
    ...
    return (
        <div
            ...
            onClick={onClose} // handle backdrop clicks
        >
            <div
                className="bg-white rounded-lg w-full max-w-4xl h-[90vh] overflow-hidden relative flex"
                ...
                <div className="bg-white rounded-lg w-full max-w-5xl h-[90vh] overflow-hidden flex flex-col lg:min-w-[900px]">
                    ...
                    <div className="flex flex-1 overflow-hidden">
                        ...
                        <div className="w-1/2 p-6 overflow-y-auto" ref={contentRef}>
                            ...
                            {/* Buttons */}
                            <button className="w-full bg-black text-white py-3 rounded-md font-medium mb-2 hover:bg-gray-800 transition-colors">
                                Add to order · LKR {totalPrice.toFixed(2)}
                            </button>
